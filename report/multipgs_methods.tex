...
\fancyhead[R]{\small\textcolor{MidGray}{v0.3.0}}
...
\toprule
\textbf{Package} & \pkg{multipgs} version 0.3.0 \\
...
\textbf{Automated result} & 322 tests passed on Python 3.12.13, NumPy 2.5.2,
scikit-learn 1.9.0, pytest 9.1.1, and ldpred3 0.4.6 \\
...
The complete automated suite passed 322 of 322 tests in the environment stated
on the title page. It covers public API validation, allele and variant
